...
/// Suspends until Ctrl-C / SIGTERM / the terminal closing. The default handlers are
/// disabled so the writers get a chance to finalise their files instead of the process
/// dying mid-frame, leaving a `.mov` with no `moov` atom that nothing can open.
